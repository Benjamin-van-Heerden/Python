...
class Quicksort:
    '''
    Using the quickselect algorith we construct a sorted array from the input
    in descending order
    '''
    ...
    def sorted(self):
        ...
        for i in range(len(self.nums)):
            sorted_list.append(self.select(0, len(self.nums)-1, i))
    ...
    def partition(self, first_index, last_index):
        ...
        for i in range(first_index, last_index):
            # change this to < if ascending order is desired
...
l = [1, 2, 3, 4, 5, 67, 21, 32, -5, -42, 42, -1, -55]
