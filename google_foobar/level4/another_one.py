...
def solution(dimensions, your_position, trainer_position, distance):
    ...
    # if the ray is too short to reach the target in the base cell we have a slight edge case
    if euclidean_dist(your_position, trainer_position) > distance:
        return 0
